...
import BookAppointment from './BookingAppointment'
    ...
    <div className='grid grid-cols-1 md:grid-cols-3 border-[1px] p-5 mt-5 rounded-lg'>
          ...
          <div className='col-span-2 mt-5 flex md:px-10 flex-col gap-3 items-baseline'>
                ...
                <h2 className='flex gap-2 text-gray-500 text-md'>
                    <GraduationCap/>
                    <span>{doctor.attributes?.Year_of_Experience} Years of Experince</span>
                </h2>
                ...
                <h2 className='text-[10px] bg-blue-100 p-1 rounded-full
                        px-2 text-primary'>{doctor.attributes?.categories.data?.attributes?.Name}</h2>
